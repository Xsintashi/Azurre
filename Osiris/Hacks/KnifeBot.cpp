...
void KnifeBotRage(UserCmd* cmd) noexcept
{
    ...
    const auto angle{ AimHelpers::calculateRelativeAngle(localPlayerEyePosition, bestTarget->getBonePosition(7), cmd->viewangles + aimPunch) };
