...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    ImGui::SetNextWindowPos(ImVec2(main_viewport->WorkPos.x + 1000, main_viewport->WorkPos.y + 20), ImGuiCond_FirstUseEver);
...
bool ImGui::ShowStyleSelector(const char* label)
{
    ...
    if (ImGui::Combo(label, &style_idx, "Genshi\0Dark\0Light\0"))
    {
        switch (style_idx)
        {
        case 0: ImGui::StyleColorsGenshi(); break;
