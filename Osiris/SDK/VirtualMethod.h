...
namespace VirtualMethod
{
    ...
    {
#ifdef _WIN32
        return x86RetSpoof::invokeThiscall<T, Args...>(std::uintptr_t(classBase), (*reinterpret_cast<std::uintptr_t**>(classBase))[Idx], memory->jmpEbxGadgetInClient, args...); // nigga crashes here idk y // debugging be like
#else
