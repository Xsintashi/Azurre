...
public:
    ...
    VIRTUAL_METHOD_V(bool, getBool, 5, (const char* keyName, bool defaultValue = false), (this, keyName, defaultValue))
    ...
    VIRTUAL_METHOD_V(void, setBool, 12, (const char* keyName, bool value), (this, keyName, value))
    VIRTUAL_METHOD_V(void, setInt, 13, (const char* keyName, int value), (this, keyName, value))
    VIRTUAL_METHOD_V(void, setFloat, 15, (const char* keyName, float value), (this, keyName, value))
